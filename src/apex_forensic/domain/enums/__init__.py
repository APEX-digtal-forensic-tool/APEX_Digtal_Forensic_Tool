...
class AiDestinationCategory(StrEnum):
    LOCAL = "LOCAL"
    EXTERNAL = "EXTERNAL"


class AiSecretHandling(StrEnum):
    DENY = "DENY"
    REDACT = "REDACT"
    ALLOW = "ALLOW"


class AiDataForm(StrEnum):
    RAW = "RAW"
...
class AiDataSourceType(StrEnum):
    ARTIFACT = "ARTIFACT"
    CONTEXT_SNAPSHOT = "CONTEXT_SNAPSHOT"
    AI_ASSISTANCE_REQUEST = "AI_ASSISTANCE_REQUEST"


class AiEgressDecision(StrEnum):
    ALLOW = "ALLOW"
    DENY = "DENY"
