...
_ARTIFACT_SCOPE_BY_TYPE: dict[str, str] = {
    ...
    ArtifactType.BROWSER_COOKIE.value: AnalysisScopeType.BROWSER.value,
    ArtifactType.BROWSER_CREDENTIAL.value: AnalysisScopeType.BROWSER.value,
    ArtifactType.BROWSER_CACHE_ENTRY.value: AnalysisScopeType.BROWSER.value,
    ArtifactType.BROWSER_DELETED_SQLITE_ROW.value: AnalysisScopeType.BROWSER.value,
    ArtifactType.BROWSER_PRIVATE_MODE_CANDIDATE.value: AnalysisScopeType.BROWSER.value,
